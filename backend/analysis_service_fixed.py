...
from app.models.request import AnalyzeRequest, ContentType
from app.models.response import ViralityAnalysis, score_to_level
...
class AnalysisService:
    ...
    async def run_analysis(
        ...
        initial_state = AgentState(
            ...
            # ── REMOVED: frames field - Gemini processes video URLs directly
        )

        logger.info("Prepared initial state", upload_id=request.upload_id)
